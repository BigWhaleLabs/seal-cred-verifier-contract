...
yarn snarkjs powersoftau contribute pot/pot20_0000.ptau pot/pot20_0001.ptau \
  --name="First contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
# yarn snarkjs powersoftau contribute pot/pot20_0001.ptau pot/pot20_0002.ptau \
#   --name="Second contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
# yarn snarkjs powersoftau contribute pot/pot20_0002.ptau pot/pot20_0003.ptau \
#   --name="Third contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"

# Verify
yarn snarkjs powersoftau verify pot/pot20_0001.ptau
...
yarn snarkjs powersoftau beacon pot/pot20_0001.ptau pot/pot20_beacon.ptau \
...
yarn snarkjs powersoftau prepare phase2 pot/pot20_beacon.ptau pot/pot20_final.ptau -v

# Verify the final ptau file. Creates the file pot20_final.ptau
yarn snarkjs powersoftau verify pot/pot20_final.ptau