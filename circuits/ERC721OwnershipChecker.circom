...
template ERC721OwnershipChecker(messageLength) {
    ...
    signal input tokenAddress[40]; // TODO: figure out the size
    // EdDSA signature
    signal input A[256];
    signal input R8[256];
    signal input S[256];
...
component main{public [attestorPublicKey, tokenAddress]} = ERC721OwnershipChecker(90); // TODO: figure out the size
